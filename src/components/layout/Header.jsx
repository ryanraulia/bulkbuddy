            ...
            <ul className="flex items-center gap-1 lg:gap-2 font-medium" role="menubar">
              {navItems.map(({ to, icon: Icon, label }) => (
                <li key={label} role="none">
                  <Link
                    to={to}
                    className={`flex items-center gap-2 ${darkMode ? 'hover:bg-[#1E1E1E]' : 'hover:bg-[#F0F0F0]'} rounded-lg px-3 py-2 transition-colors duration-200 ${darkMode ? 'text-[#FFFFFF]' : 'text-[#212529]'} hover:text-[#007BFF] focus:outline-none focus:ring-2 focus:ring-blue-500`}
                    role="menuitem"
                  >
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <div className="flex items-center gap-3">
                <Link 
                  to="/profile" 
                  className={`flex items-center gap-2 ${darkMode ? 'bg-[#1E1E1E] hover:bg-[#2D2D2D]' : 'bg-[#FAFAFA] hover:bg-[#F0F0F0]'} rounded-lg py-2 px-4 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500`}
              ...
              <div className="flex items-center gap-3">
                <LoginButton 
                  ...
                  className={`${darkMode ? 'bg-[#1E1E1E] hover:bg-[#2D2D2D]' : 'bg-[#FAFAFA] hover:bg-[#F0F0F0]'} text-[#212529] font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500`} 
                />
                <SignUpButton 
