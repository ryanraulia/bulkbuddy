...
export default function Calculators() {
  ...
  return (
    <div className={`min-h-screen py-8 ${darkMode ? 'bg-gradient-to-b from-[#1E1E1E] via-[#2D2D2D] to-[#1E1E1E]' : 'bg-gradient-to-b from-gray-100 via-gray-50 to-gray-100'} ${darkMode ? 'text-[#E0E0E0]' : 'text-[#212529]'}`}>
