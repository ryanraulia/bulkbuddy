  ...
  return (
    <div className={`min-h-screen py-8 ${darkMode ? 'bg-gradient-to-b from-[#121212] via-[#181818] to-[#121212]' : 'bg-gradient-to-b from-gray-100 via-gray-50 to-gray-100'}`}>
      <div className="max-w-4xl mx-auto p-6">
        <div className={`${darkMode ? 'bg-[#2D2D2D] border-gray-700' : 'bg-white border-gray-200'} p-8 rounded-lg shadow-xl border-4`}>
          <h1 className={`text-4xl font-extrabold text-center ${darkMode ? 'text-blue-400' : 'text-[#007BFF]'} mb-6`}>Contact Us</h1>
